...
import { FormLayout } from '../../../node_modules/@supabase/ui/dist/esm/lib/Layout/FormLayout/FormLayout'
import InputErrorIcon from '../../../node_modules/@supabase/ui/dist/esm/lib/Layout/InputErrorIcon'
import InputIconContainer from '../../../node_modules/@supabase/ui/dist/esm/lib/Layout/InputIconContainer'
...
function Input({
    ...
    function handleBlurEvent(e: React.FocusEvent<HTMLInputElement>) {
        if (handleBlur && shouldHandleFormik) handleBlur(e)
        if (onBlur) onBlur(e)
    }
    ...
    function onInputChange(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        // update form
        if (formContextOnChange && shouldHandleFormik) formContextOnChange(e)
